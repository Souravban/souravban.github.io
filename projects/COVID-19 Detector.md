...
<div class="buttons">
		<b><br><center><button onclick="location.href='https://nbviewer.jupyter.org/github/iamsouravbanerjee/COVID-19-Detection-from-X-Ray-Images/blob/master/COVID%20Detection%20using%20Chest%20X-Rays.ipynb'" style="margin-right: 30px" type="button">View Code</button> <button onclick="location.href='https://www.youtube.com/watch?v=SqmGMiM7DCA'" type="button">Demo</button> <button onclick="location.href='https://www.youtube.com/watch?v=4UBQLQfnaPg'" type="button">Video Explanation</button><br><br><br><br>
