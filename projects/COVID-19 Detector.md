...
labels:
  ...
  - HTML
  - JavaScript
summary: <b>This is an Image Detector which can detect Covid-19 from Chest X-Ray images.<br><center><button onclick="location.href='https://www.youtube.com/watch?v=SqmGMiM7DCA'" type="button">WATCH DEMO</button></br></center></b>
---
